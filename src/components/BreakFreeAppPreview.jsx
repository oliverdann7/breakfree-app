...
import {
  Activity, Heart, Moon, Flame, TrendingUp, Award,
  Play, Pause, Mic, Calendar, Users, MessageCircle,
  ChevronRight, ArrowUpRight, Sparkles, Target, Zap,
  BookOpen, Headphones, Video, Star, Plus, Search,
  Home, Compass, User, Bell, Settings, MapPin,
  Clock, ArrowRight, Brain, Dumbbell, Apple,
  CheckCircle2, Circle, BarChart3, Footprints,
  Sun, Quote, Radio
} from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 text-center">
        <div className={`inline-flex items-center gap-2 rounded-full px-3 py-1 text-[10px] uppercase tracking-[0.25em] ${
      ...
      >
        {/* Glow */}
        <div className={`absolute -inset-8 rounded-[60px] blur-3xl opacity-30 ${
          ...
          <div className="relative h-full w-full overflow-hidden rounded-[40px] bg-[#0A2540]">
            ...
            <div className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-6 pt-3 text-[10px] text-white font-semibold">
              ...
              <div className="flex items-center gap-1">
                ...
                <svg width="12" height="8" viewBox="0 0 12 8" fill="white"><path d="M6 0a6 6 0 0 0-6 6h1.5A4.5 4.5 0 0 1 6 1.5 4.5 4.5 0 0 1 10.5 6H12A6 6 0 0 0 6 0z"/></svg>
    ...
    <div className="relative flex h-full flex-col px-6 pb-8 pt-12">
      ...
      <div className="text-center">
        <h2 className="font-display text-3xl font-light leading-tight text-white">
          Özgürlüğüne <br/><span className="italic text-[#E6B530]">hoş geldin.</span>
        </h2>
    ...
    <div className="h-full overflow-y-auto pb-20 scrollbar-hide">
      ...
      <div className="px-5 pt-4">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-[10px] uppercase tracking-widest text-white/40">Pazar, 15 Haziran</div>
      ...
      <div className="mx-5 mt-4">
        ...
        <div className="space-y-2">
          {[
            ...
            { time: '20:00', title: 'Wellness palestrası', dur: '30dk', done: false, icon: Mic, accent: true },
          ].map((t, i) => (
            <div
              key={i}
            ...
            >
              <div className={`flex h-9 w-9 items-center justify-center rounded-lg ${
                t.done ? 'bg-[#14B8D4]/20 text-[#14B8D4]' : t.accent ? 'bg-[#E6B530] text-[#0A2540]' : 'bg-white/10 text-white'
              }`}>
                {t.done ? <CheckCircle2 className="h-4 w-4" /> : <t.icon className="h-4 w-4" />}
              </div>
              <div className="flex-1">
                <div className={`text-[11px] font-medium ${t.done ? 'text-white/40 line-through' : 'text-white'}`}>
                  {t.title}
                </div>
                <div className="text-[9px] text-white/40">{t.time} · {t.dur}</div>
              </div>
              {t.accent && (
    ...
    <div className="absolute bottom-0 left-0 right-0 border-t border-white/10 bg-[#061829]/90 px-6 py-2 backdrop-blur-xl">
      <div className="flex justify-between">
        {[
          ...
          <div key={i} className={`flex flex-col items-center gap-0.5 px-1 py-1.5 ${t.active ? 'text-[#E6B530]' : 'text-white/40'}`}>
    ...
    <div className="h-full overflow-y-auto pb-20 scrollbar-hide">
      ...
      <div className="mx-5 mt-4 overflow-hidden rounded-2xl border border-[#E6B530]/30 bg-gradient-to-br from-[#E6B530]/15 via-[#E6B530]/5 to-transparent p-4">
        ...
        <h3 className="mt-3 font-display text-lg font-light leading-tight text-white">
          Yorgunluğun ardındaki<br/><span className="italic text-[#E6B530]">gerçek hikaye</span>
        </h3>
      ...
      <div className="mx-5 mt-4">
        ...
        <div className="mt-2 overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03]">
          ...
          <div className="p-3">
            <div className="text-[9px] uppercase tracking-wider text-[#14B8D4]">Beslenme · Bölüm 12</div>
      ...
      <div className="mx-5 mt-4">
        ...
        <div className="space-y-2">
          {[
            { cat: 'Zihin', title: 'Anksiyeteyi anlamak', dur: '28dk', host: 'Dr. Ayşe', g: 'from-[#14B8D4] to-[#0B72B9]' },
            { cat: 'Hareket', title: 'Koşunun bilimi', dur: '35dk', host: 'Mehmet Ç.', g: 'from-[#E6B530] to-[#C99419]' },
            { cat: 'Uyku', title: 'Derin uykuya yolculuk', dur: '22dk', host: 'Dr. Levent', g: 'from-[#0B72B9] to-[#0A2540]' },
          ].map((t, i) => (
            <div key={i} className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/[0.03] p-2">
              <div className={`h-12 w-12 shrink-0 rounded-lg bg-gradient-to-br ${t.g} flex items-center justify-center`}>
                <Play className="h-4 w-4 fill-white text-white ml-0.5" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="text-[8px] uppercase tracking-wider text-[#E6B530]">{t.cat}</div>
                <div className="mt-0.5 text-[11px] font-medium leading-tight text-white truncate">{t.title}</div>
                <div className="text-[9px] text-white/40">{t.host} · {t.dur}</div>
              </div>
    ...
    <div className="h-full overflow-y-auto pb-20 scrollbar-hide">
      ...
      <div className="-mt-2 mx-5 grid grid-cols-3 gap-2">
        {[
          ...
          <div key={i} className="flex flex-col items-center gap-1 rounded-xl border border-white/10 bg-[#061829] p-2.5">
      ...
      <div className="mx-5 mt-4 rounded-2xl border border-[#E6B530]/20 bg-gradient-to-br from-[#E6B530]/10 to-transparent p-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] uppercase tracking-widest text-[#E6B530]">Bu hafta odak</span>
        </div>
        ...
        <div className="mt-3 space-y-2">
          {[
            ...
            <div key={i} className="flex items-center gap-2">
              ...
              <span className={`text-[11px] ${g.done ? 'text-white/40 line-through' : 'text-white'}`}>
                {g.l}
              </span>
            </div>
          ))}
      ...
      <div className="mx-5 mt-3 rounded-2xl border border-white/10 bg-white/[0.03] p-3">
        ...
        <div className="mt-2 flex gap-2">
          <div className="h-7 w-7 shrink-0 rounded-full bg-gradient-to-br from-[#E6B530] to-[#C99419] flex items-center justify-center text-[10px] font-semibold text-[#0A2540]">A</div>
  ...
  <div className="relative h-full w-full overflow-hidden bg-[#061829]">
    <div className="h-full overflow-y-auto pb-20 scrollbar-hide">
      <div className="px-5 pt-4">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-[10px] uppercase tracking-widest text-white/40">Detaylı analiz</div>
      ...
      <div className="mx-5 mt-4 flex gap-1 rounded-full border border-white/10 bg-white/[0.03] p-1">
        {['Gün', 'Hafta', 'Ay', 'Yıl'].map((p, i) => (
          <div key={i} className={`flex-1 rounded-full py-1.5 text-center text-[10px] font-medium ${
      ...
      <div className="mx-5 mt-4 rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent p-4">
        ...
        <div className="mt-4 h-24 w-full">
          <svg viewBox="0 0 240 80" className="h-full w-full">
            ...
            />
            {[[0,60],[34,50],[68,55],[102,35],[136,40],[170,25],[204,30],[240,15]].map(([x,y],i) => (
              <circle key={i} cx={x} cy={y} r="2.5" fill={C.navy} stroke={C.gold} strokeWidth="1.5" />
            ))}
          </svg>
        </div>
      ...
      <div className="mx-5 mt-4 mb-5 rounded-2xl border border-[#E6B530]/30 bg-gradient-to-br from-[#E6B530]/10 to-transparent p-3">
        ...
        <p className="mt-2 text-[11px] leading-relaxed text-white/85">
          Uyku puanın bu hafta <span className="text-[#E6B530] font-medium">%14 yükseldi</span>. Akşam meditasyonu rutinini sürdürmeni öneririm — sonuçlar harika.
        </p>
      </div>
    </div>
...
const ScreenCommunity = () => (
  <div className="relative h-full w-full overflow-hidden bg-[#061829]">
    <div className="h-full overflow-y-auto pb-20 scrollbar-hide">
      ...
      <div className="mt-4 flex gap-3 overflow-x-auto px-5 pb-2 scrollbar-hide">
        {[
          ...
          <div key={i} className="flex shrink-0 flex-col items-center gap-1">
            <div className={`flex h-12 w-12 items-center justify-center rounded-full p-0.5 ${
              s.accent ? 'border border-dashed border-[#E6B530]' : 'bg-gradient-to-br from-[#E6B530] to-[#C99419]'
            }`}>
              <div className={`flex h-full w-full items-center justify-center rounded-full ${
                s.accent ? 'bg-[#061829] text-[#E6B530]' : `bg-gradient-to-br ${s.g} text-white text-sm font-medium`
              }`}>
                {s.init}
              </div>
            </div>
      ...
      <div className="mx-5 mt-3 rounded-2xl border border-white/10 bg-white/[0.03] p-3">
        <div className="flex items-center gap-2">
          <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#14B8D4] to-[#0B72B9] flex items-center justify-center text-xs font-medium text-white">B</div>
          <div className="flex-1">
            <div className="flex items-center gap-1.5">
        ...
        <p className="mt-2 text-[11px] leading-relaxed text-white/85">
          Bu sabahki 10K koşuyu bitirdim 🌅 İlk kez sub-50'ye girdim. BreakFree topluluğu olmasaydı asla olmazdı.
        </p>
      ...
      <div className="mx-5 mt-3 mb-5 rounded-2xl border border-white/10 bg-gradient-to-br from-[#14B8D4]/10 to-transparent p-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] uppercase tracking-widest text-[#14B8D4]">Haftalık meydan okuma</span>
          </div>
...
export default function BreakFreeAppPreview() {
  return (
    <div className="min-h-screen bg-[#061829] text-white" style={{ fontFamily: '"Manrope", system-ui, sans-serif' }}>
      <style>{`
          ...
          <div className="mx-auto max-w-7xl">
            ...
            >
              ...
              <p className="mt-8 max-w-2xl text-lg font-light leading-relaxed text-white/60 md:text-xl">
                BreakFree mobil deneyimi: bütünsel sağlık verileri, kişisel mentor,
                canlı palestralar, topluluk akışı ve etkinlik takvimi —
                tek bir uygulamada.
              </p>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-16 max-w-3xl">
              ...
              <h2 className="font-display text-5xl font-light leading-[1.05] tracking-tight md:text-6xl">
                Sadece bir app değil — <span className="italic text-[#E6B530]">bir yaşam katmanı.</span>
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  items: ['Onboarding', 'Etkinlik takvimi', 'Topluluk akışı', 'Podcast/palestralar', 'Profil & rozetler'],
                  status: 'Tasarım',
                },
                {
                  phase: 'V2 · Sağlık',
                  ...
                  items: ['Apple Health & Google Fit', 'Wellness skoru', 'Detaylı analitik', 'AI içgörüler', 'Haftalık meydan okumalar'],
                  status: 'Planlanıyor',
                  accent: true,
                },
                {
                  ...
                  items: ['1-1 mentörlük', 'Görüntülü görüşme', 'Sertifikalı koçlar', 'Kişiselleştirilmiş plan', 'Aile hesapları'],
                  status: 'Vizyon',
                },
              ].map((p, i) => (
                <motion.div
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className={`text-[10px] uppercase tracking-[0.25em] ${p.accent ? 'text-[#0A2540]/70' : 'text-[#E6B530]'}`}>
                      {p.phase}
                    </span>
                    <span className={`text-[10px] ${p.accent ? 'text-[#0A2540]/70' : 'text-white/40'}`}>
                      {p.date}
                    </span>
                  </div>
                  <h3 className={`mt-4 font-display text-3xl font-light leading-tight ${p.accent ? 'text-[#0A2540]' : 'text-white'}`}>
                    {p.title}
                  </h3>
                  <ul className={`mt-6 space-y-2 text-sm ${p.accent ? 'text-[#0A2540]/80' : 'text-white/70'}`}>
                    {p.items.map((item, j) => (
                      <li key={j} className="flex items-center gap-2">
                        <div className={`h-1 w-1 rounded-full ${p.accent ? 'bg-[#0A2540]' : 'bg-[#E6B530]'}`} />
                        {item}
                      </li>
                    ))}
                  </ul>
                  <div className={`mt-8 inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[10px] uppercase tracking-wider ${
                    p.accent ? 'bg-[#0A2540] text-[#E6B530]' : 'border border-white/15 text-white/50'
                  }`}>
                    <span className={`h-1.5 w-1.5 rounded-full ${p.accent ? 'bg-[#E6B530]' : 'bg-white/40'}`} />
                    {p.status}
                  </div>
                </motion.div>
              ))}
