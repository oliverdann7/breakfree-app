...
const Ico = {
  ...
  sparkles:
    'M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5L12 3zM4 17l.8 2.4L7 20l-2.2.8L4 23l-.8-2.2L1 20l2.2-.8L4 17zM20 3l.8 2.4L23 6l-2.2.8L20 9l-.8-2.2L17 6l2.2-.8L20 3z',
  calendar: 'M3 4h18v18H3zM16 2v4M8 2v4M3 10h18',
  brain:
    'M9.5 2A2.5 2.5 0 007 4.5v.5H5a2 2 0 00-2 2v12a2 2 0 002 2h14a2 2 0 002-2V7a2 2 0 00-2-2h-2v-.5A2.5 2.5 0 0014.5 2h-5z',
      ...
      >
        ...
        <div
          style={{
            ...
            inset: -24,
            borderRadius: 56,
            background: accent ? C.gold : C.cyan,
            opacity: 0.18,
            filter: 'blur(40px)',
            pointerEvents: 'none',
          }}
        ...
        >
          ...
          {[
            { t: 80, h: 28, left: true },
            { t: 120, h: 44, left: true },
            { t: 174, h: 44, left: true },
            { t: 100, h: 56, left: false },
          ].map((b, i) => (
            <div
              key={i}
              style={{
                ...
                top: b.t,
                left: b.left ? -2.5 : 'auto',
                right: b.left ? 'auto' : -2.5,
              }}
            />
          ))}
          {/* screen */}
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                <div style={{ display: 'flex', gap: 2, alignItems: 'flex-end' }}>
                  {[6, 8, 10, 10].map((h, i) => (
                    <div
                      key={i}
                      style={{ width: 2, height: h, background: '#fff', borderRadius: 1 }}
                    />
                  ))}
                </div>
                <div
      ...
      {tabs.map((t, i) => (
        <div
          ...
          style={{
            ...
            alignItems: 'center',
            gap: 2,
            color: i === active ? C.gold : 'rgba(255,255,255,0.35)',
            cursor: 'pointer',
          }}
        >
  ...
  return (
    <div
      style={{
        height: '100%',
        position: 'relative',
        background: `linear-gradient(135deg, ${C.navy}, ${C.royal}50, ${C.navy})`,
      }}
    >
      {/* blobs */}
      {[
        ...
        <motion.div
          ...
          style={{
            position: 'absolute',
            ...(b.t !== undefined ? { top: b.t } : { bottom: b.b }),
            ...(b.l !== undefined ? { left: b.l } : { right: b.r }),
            width: b.size,
            height: b.size,
            borderRadius: '50%',
            background: b.bg,
      ...
      >
        ...
        >
          <motion.div
            ...
            style={{
              ...
              height: 140,
              borderRadius: '50%',
              border: `1px solid rgba(230,181,48,0.2)`,
            }}
          />
          <motion.div
            animate={{ rotate: -360 }}
          ...
          {[
            ...
            <motion.div
              ...
              style={{
                position: 'absolute',
                ...(tag.t !== undefined ? { top: tag.t } : { bottom: tag.b }),
        ...
        <div style={{ textAlign: 'center', marginBottom: 16 }}>
          ...
          >
            Özgürlüğüne
            <br />
            <em style={{ color: C.gold }}>hoş geldin.</em>
          </h2>
          <p
            style={{ fontSize: 10, color: 'rgba(255,255,255,0.55)', marginTop: 8, lineHeight: 1.6 }}
          >
        ...
        <div style={{ display: 'flex', gap: 6, marginTop: 12 }}>
          ...
          <div
            style={{ width: 6, height: 3, borderRadius: 999, background: 'rgba(255,255,255,0.2)' }}
          />
          <div
            style={{ width: 6, height: 3, borderRadius: 999, background: 'rgba(255,255,255,0.2)' }}
          />
      ...
      >
        ...
        <div
          style={{
            ...
            border: `1px solid rgba(230,181,48,0.2)`,
            background:
              'linear-gradient(135deg,rgba(230,181,48,0.08),transparent,rgba(20,184,212,0.05))',
            padding: 14,
            marginBottom: 10,
            display: 'flex',
            alignItems: 'center',
        ...
        {/* today plan */}
        <div>
          <div style={{ fontSize: 10, fontWeight: 600, color: '#fff', marginBottom: 6 }}>
            Bugünkü plan
          </div>
            ...
            {plan.map((p, i) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: 12,
                  border: p.live
                    ? `1px solid rgba(230,181,48,0.3)`
                    : '1px solid rgba(255,255,255,0.07)',
                  background: p.live ? 'rgba(230,181,48,0.06)' : 'rgba(255,255,255,0.02)',
                  padding: '8px 10px',
                }}
              >
                <div
                ...
                >
                  <Icon
                    d={p.done ? Ico.check : p.ico}
                    size={13}
                    stroke={p.done ? C.cyan : p.live ? C.navy : '#fff'}
                  />
                </div>
                <div style={{ flex: 1 }}>
                  <div
                    style={{
                      fontSize: 10,
                      fontWeight: 600,
                      color: p.done ? 'rgba(255,255,255,0.35)' : '#fff',
...
function S3() {
  const list = [
    {
      cat: 'Zihin',
      t: 'Anksiyeteyi anlamak',
      dur: '28dk',
      g: `linear-gradient(135deg,${C.cyan},${C.royal})`,
    },
    {
      cat: 'Hareket',
      t: 'Koşunun bilimi',
      dur: '35dk',
      g: `linear-gradient(135deg,${C.gold},${C.amber})`,
    },
    {
      cat: 'Uyku',
      t: 'Derin uykuya yolculuk',
      dur: '22dk',
      g: `linear-gradient(135deg,${C.royal},${C.navy})`,
    },
  ];
  return (
    <div style={{ height: '100%', background: C.deep, position: 'relative', overflow: 'hidden' }}>
      ...
      >
        ...
        <div
          style={{
            borderRadius: 18,
            border: `1px solid rgba(230,181,48,0.3)`,
            background:
              'linear-gradient(135deg,rgba(230,181,48,0.12),rgba(230,181,48,0.04),transparent)',
            padding: 14,
            marginBottom: 10,
          }}
        >
          ...
          >
            ...
            <br />
            <em style={{ color: C.gold }}>gerçek hikaye</em>
          </div>
          ...
          {['Tümü', 'Beslenme', 'Zihin', 'Hareket', 'Uyku'].map((c, i) => (
            <div
              ...
              style={{
                ...
                color: i === 0 ? C.navy : 'rgba(255,255,255,0.6)',
        ...
        >
          <div
            style={{
              height: 80,
              background: `linear-gradient(135deg,${C.royal},${C.cyan},${C.gold})`,
              position: 'relative',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
          ...
          <div style={{ padding: '10px 12px', background: 'rgba(255,255,255,0.02)' }}>
            ...
            <div style={{ fontSize: 8, color: 'rgba(255,255,255,0.4)', marginTop: 5 }}>
              Selin Kaya
            </div>
          </div>
        </div>
          ...
          {list.map((t, i) => (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: 10, fontWeight: 600, color: '#fff', marginTop: 2 }}>
                  {t.t}
                </div>
      ...
      >
          ...
          {['Gün', 'Hafta', 'Ay', 'Yıl'].map((p, i) => (
            <div
              ...
              style={{
                ...
                fontWeight: 600,
                cursor: 'pointer',
                background: i === 1 ? C.gold : 'transparent',
                color: i === 1 ? C.navy : 'rgba(255,255,255,0.5)',
              }}
            >
              {p}
            </div>
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 4 }}>
            {['Pzt', 'Sal', 'Çar', 'Per', 'Cum', 'Cmt', 'Paz'].map((d) => (
              <span key={d} style={{ fontSize: 7, color: 'rgba(255,255,255,0.3)' }}>
                {d}
              </span>
            ))}
          </div>
          ...
          {bars.map((b, i) => (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                ...
                <span
                  style={{ fontFamily: "'Fraunces',Georgia,serif", fontSize: 14, color: '#fff' }}
                >
                  {b.v}
                </span>
              </div>
        ...
        <div
          style={{
            marginTop: 10,
            borderRadius: 14,
            border: `1px solid rgba(230,181,48,0.25)`,
            background: 'rgba(230,181,48,0.07)',
            padding: 12,
          }}
        >
          ...
          <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.85)', lineHeight: 1.6, margin: 0 }}>
            Uyku puanın bu hafta{' '}
            <span style={{ color: C.gold, fontWeight: 700 }}>%14 yükseldi</span>. Akşam rutinini
            sürdür!
          </p>
        </div>
      </div>
...
function S5() {
  ...
  return (
    <div style={{ height: '100%', background: C.deep, position: 'relative', overflow: 'hidden' }}>
      <div
        style={{ height: '100%', overflowY: 'auto', padding: '0 0 60px', scrollbarWidth: 'none' }}
      >
        {/* mentor header */}
        <div style={{ height: 130, position: 'relative', overflow: 'hidden' }}>
          ...
          <div
            style={{
              position: 'absolute',
              inset: 0,
              background: 'linear-gradient(to top, rgba(6,24,41,0.95) 0%, transparent 60%)',
            }}
          />
          <div
            style={{
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontFamily: "'Fraunces',Georgia,serif", fontSize: 16, color: '#fff' }}>
                Dr. Ayşe Demir
              </div>
              <div style={{ fontSize: 8, color: 'rgba(255,255,255,0.6)' }}>
                Wellness · 8 yıl deneyim
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '0 14px' }}>
          ...
          >
            {[
              { i: Ico.message, l: 'Sohbet' },
              { i: Ico.video, l: 'Görüşme' },
              { i: Ico.calendar, l: 'Planla' },
            ].map((a, i) => (
              <div
                key={i}
                style={{
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'flex-start' }}>
              ...
              >
                ...
                >
                  Elif, bu haftaki ilerlemen harika 🌟 Pazartesi seansında uyku verilerine birlikte
                  bakalım.
                </p>
              </div>
            </div>
      ...
      >
              ...
              >
                <div
                  style={{
                    ...
                    height: '100%',
                    borderRadius: '50%',
                    background: s.add ? C.deep : s.g,
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    fontSize: s.add ? 18 : 14,
                    color: s.add ? C.gold : '#fff',
                    fontWeight: 600,
                  }}
                >
                  {s.add ? '+' : s.l[0]}
        ...
        >
          ...
          >
            <div
              style={{
                position: 'absolute',
                inset: 0,
                background: 'linear-gradient(to top, rgba(6,24,41,0.85) 0%, transparent 50%)',
              }}
            />
            <div
              style={{
            ...
            <div style={{ position: 'absolute', bottom: 8, left: 10 }}>
              ...
              <div style={{ fontFamily: "'Fraunces',Georgia,serif", fontSize: 15, color: '#fff' }}>
                Belgrad Şafak
              </div>
            </div>
          </div>
          <div
            style={{
              padding: '10px 12px',
              background: 'rgba(230,181,48,0.05)',
              display: 'flex',
              justifyContent: 'space-between',
              alignItems: 'center',
            }}
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
            <div
              style={{
                ...
                height: 30,
                borderRadius: '50%',
                background: `linear-gradient(135deg,${C.cyan},${C.royal})`,
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                fontSize: 11,
          ...
          >
            {[
              { l: '10.2 km', i: Ico.foot },
              { l: '48:32', i: Ico.clock },
              { l: '142 bpm', i: Ico.heart },
            ].map((s, i) => (
              <div
                key={i}
                style={{
              ...
              >
                ...
                <div style={{ fontSize: 9, fontWeight: 700, color: '#fff', marginTop: 4 }}>
                  {s.l}
                </div>
              </div>
            ))}
    ...
    <div style={{ height: '100%', background: C.deep, position: 'relative', overflow: 'hidden' }}>
      ...
      >
        ...
        >
          <div
            style={{
              position: 'absolute',
              inset: 0,
              background: 'linear-gradient(to bottom, transparent, rgba(6,24,41,0.9))',
            }}
          />
          <div style={{ position: 'relative' }}>
            <div
            ...
            >
              {workout.coach} · {workout.difficulty}
            </div>
            <div
              style={{
                fontFamily: "'Fraunces',Georgia,serif",
            ...
            <div style={{ fontSize: 9, color: 'rgba(255,255,255,0.6)', marginTop: 2 }}>
              {workout.duration}min · {workout.cal} cal
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '12px 14px' }}>
          ...
          {/* exercises */}
          <div>
            <div style={{ fontSize: 10, fontWeight: 600, color: '#fff', marginBottom: 8 }}>
              Egzersizler
            </div>
              ...
              {workout.exercises.map((ex, i) => (
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: 3 }}>
                    {Array(parseInt(ex.sets.split('x')[0]))
                      .fill(0)
                      .map((_, j) => (
                        <div
                          key={j}
                          style={{
                            ...
                            height: 24,
                            borderRadius: 8,
                            background: j < ex.done ? C.gold : 'rgba(255,255,255,0.1)',
                            display: 'flex',
                            alignItems: 'center',
                            justifyContent: 'center',
                            fontSize: 8,
                            fontWeight: 700,
                            color: j < ex.done ? C.navy : 'rgba(255,255,255,0.3)',
                          }}
                        >
                          {j + 1}
                        </div>
    ...
    <div style={{ height: '100%', background: C.deep, position: 'relative', overflow: 'hidden' }}>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 14, fontFamily: "'Fraunces',Georgia,serif", color: '#fff' }}>
            Elif Kaya
          </div>
              ...
              {sec.items.map((item, j) => (
                <div
                  ...
                  style={{
                    ...
                    padding: '12px 12px',
                    borderBottom:
                      j < sec.items.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none',
      ...
      <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
        <div
          style={{
            position: 'absolute',
            inset: 0,
            background: `linear-gradient(160deg,${C.navy},${C.deep},#000)`,
          }}
        />
        <motion.div
        ...
        <header style={{ maxWidth: 1100, margin: '0 auto', padding: '64px 32px 48px' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 32 }}>
              ...
              <span
                style={{
                  marginLeft: 8,
                  border: `1px solid rgba(230,181,48,0.3)`,
                  background: 'rgba(230,181,48,0.08)',
                  color: C.gold,
                  borderRadius: 999,
                  padding: '3px 12px',
                  fontSize: 9,
            ...
            >
              Topluluk
              <br />
              <em style={{ color: C.gold }}>cebinde.</em>
            </h1>
            <p
              style={{
                maxWidth: 520,
            ...
            >
              Bütünsel sağlık metrikleri, canlı palestralar, kişisel mentörlük ve topluluk — tek
              uygulamada. Türkiye'nin wellness hareketinin dijital yüzü.
            </p>
            ...
            {[
              {
                ...
                d: 'Uyku, nabız, adım, kalori, stres. Apple Health & Google Fit.',
                accent: true,
              },
              {
                i: Ico.mic,
                t: 'Canlı palestralar',
                d: "Türkiye'nin en iyi uzmanlarından canlı yayınlar ve podcast'ler.",
              },
              {
                i: Ico.sparkles,
                t: 'AI içgörüler',
                d: 'Kişiselleştirilmiş öneriler sunan akıllı asistan.',
              },
              {
                i: Ico.user,
                t: '1-1 mentörlük',
                d: 'Sertifikalı koçlar ile haftalık görüntülü görüşme ve hedef takibi.',
                accent: true,
              },
              {
                i: Ico.users,
                t: 'Topluluk akışı',
                d: "Antrenmanlarını paylaş, story'ler, tebrikler, meydan okumalar.",
              },
              {
                i: Ico.calendar,
                t: 'Etkinlik takvimi',
                d: 'Doğa yürüyüşleri, atölyeler. Tek dokunuşla RSVP ve geri sayım.',
              },
            ].map((f, i) => (
              <motion.div
                key={i}
                ...
                style={{
                  ...
                  background: f.accent ? 'rgba(230,181,48,0.07)' : 'rgba(255,255,255,0.02)',
                  padding: 28,
                  cursor: 'pointer',
                }}
              >
                <div
                  style={{
                    ...
                    height: 44,
                    borderRadius: 14,
                    background: f.accent ? C.gold : 'rgba(255,255,255,0.08)',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    marginBottom: 16,
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 16 }}>
                  <span
                    style={{
                      ...
                      textTransform: 'uppercase',
                      letterSpacing: '0.2em',
                      color: p.accent ? 'rgba(10,37,64,0.7)' : C.gold,
                      fontWeight: 600,
                    }}
                  >
                    {p.phase}
                  ...
                  <span
                    style={{
                      fontSize: 9,
                      color: p.accent ? 'rgba(10,37,64,0.6)' : 'rgba(255,255,255,0.35)',
                    }}
                  >
                    {p.date}
                  </span>
                  ...
                  {p.items.map((item, j) => (
                    <li
                      ...
                      style={{
                        ...
                        gap: 8,
                        fontSize: 13,
                        color: p.accent ? 'rgba(10,37,64,0.75)' : 'rgba(255,255,255,0.65)',
                      }}
                    >
                      <div
                        style={{
                          ...
                          height: 5,
                          borderRadius: '50%',
                          background: p.accent ? C.navy : C.gold,
                          flexShrink: 0,
                        }}
                      />
                      {item}
                ...
                <div
                  style={{
                    ...
                    letterSpacing: '0.15em',
                    fontWeight: 600,
                    background: p.accent ? C.navy : 'rgba(255,255,255,0.06)',
                    color: p.accent ? C.gold : 'rgba(255,255,255,0.45)',
                ...
                >
                  <div
                    style={{
                      ...
                      height: 5,
                      borderRadius: '50%',
                      background: p.accent ? C.gold : 'rgba(255,255,255,0.3)',
                    }}
                  />
                  {p.status}
                </div>
