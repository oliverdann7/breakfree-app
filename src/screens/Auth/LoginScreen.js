...
export default function LoginScreen({ navigation }) {
  ...
  const handleLogin = async () => {
    ...
    if (login.rejected.match(result)) {
      Alert.alert('Giriş Başarısız', result.payload || 'E-posta veya şifre yanlış.');
    }
  };
  ...
  const handleGoogleLogin = async () => {
    ...
    if (loginWithGoogle.rejected.match(result)) {
      Alert.alert('Giriş Başarısız', result.payload || 'Google ile giriş başarısız.');
    }
  };
  ...
  const handleAppleLogin = async () => {
    ...
    if (loginWithApple.rejected.match(result)) {
      Alert.alert('Giriş Başarısız', result.payload || 'Apple ile giriş başarısız.');
    }
  };
