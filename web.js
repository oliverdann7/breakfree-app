...
function WebAppContent() {
  ...
  // Lightweight pathname routing (mirrors src/WebApp.jsx). These must run
  // before the auth branch: /admin and /legal render regardless of login state
  // (AdminPage carries its own gate).
